...
//Name: penguinModel_2.ma
//Last modified: Sun, Nov 01, 2015 06:47:54 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 15.609678258525106 6.8631965803816275 -0.2018437943635405 ;
	setAttr ".r" -type "double3" -2.1383527561302276 1172.1999999997895 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.205108300463515;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.15494823455810547 7.9846704006195068 2.0728094577789307 ;
...
createNode transform -n "hatRim" -p "penguin";
	setAttr ".t" -type "double3" 0 8.7603805947633049 0 ;
...
createNode transform -n "eye1" -p "penguin";
	setAttr ".t" -type "double3" 3.5568170202198619 6.1324837640235819 -1.2451236820748632 ;
	setAttr ".s" -type "double3" 1.6026049735137493 1.6026049735137493 1.6026049735137493 ;
...
createNode transform -n "beak1" -p "penguin";
	setAttr ".t" -type "double3" 4.1319130399736261 5.3699767992555243 -0.0025536728349238591 ;
	setAttr ".r" -type "double3" -90.000000000002245 -90 4.0711099922733015e-013 ;
	setAttr ".s" -type "double3" 0.40890270173373749 0.40890270173373749 0.40890270173373749 ;
createNode mesh -n "beak1Shape" -p "beak1";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "foot1" -p "penguin";
	setAttr ".t" -type "double3" 0.35366391593699636 0.77688483589466795 -1.6891153074247907 ;
	setAttr ".r" -type "double3" 0 180 0 ;
	setAttr ".s" -type "double3" 1.3844713666780433 0.87749286625395684 1 ;
...
createNode transform -n "polySurface1";
	setAttr ".t" -type "double3" 0 -1.6051623705320497 0.022165688138753525 ;
...
createNode transform -n "polySurface2";
	setAttr ".t" -type "double3" 0 -1.6051623705320497 -9.4518907691660168 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "deleteComponent7.og" "hatRimShape.i";
...
connectAttr "deleteComponent49.og" "polySurfaceShape5.i";
...
connectAttr "beak1Shape.iog" ":initialShadingGroup.dsm" -na;
...
connectAttr "foot1Shape.iog" ":initialShadingGroup.dsm" -na;
